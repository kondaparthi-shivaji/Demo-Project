...
namespace DemoProjectPOC.Controllers
{
    public class DemoAPIController : ApiController
    {
        ...
        public HttpResponseMessage Employeedata(EmpPostData empData)
        {
            ...
            try
            {
                ...
                || empData.EmpDesignation == null || string.IsNullOrEmpty(empData.EmpDomain) || empData.EmpDomain == null
                 || (empData.EmpDOB == DateTime.MinValue) || empData.EmpDOB == null || string.IsNullOrEmpty(empData.ActiveFlag) || empData.ActiveFlag == null)
                {
